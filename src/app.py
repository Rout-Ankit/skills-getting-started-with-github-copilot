...
activities = {
    ...
    "Swimming Club": {
        "description": "Develop swimming techniques and endurance in the school pool",
    ...
    "Music Ensemble": {
        "description": "Play instruments together and prepare performances for school events",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["sophia@mergington.edu", "ethan@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Work on science challenges and compete in academic competitions",
